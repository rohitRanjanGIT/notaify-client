          ...
          <div className="relative flex h-full items-center justify-center px-12 py-12 text-center">
            <div className="max-w-md space-y-6">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Notaify helps you track Express.js runtime errors and
                receive real-time notifications so you can act
          ...
          <div className="w-full max-w-md">
            <div className="mb-8 text-center">
              <h2 className="text-3xl font-semibold">
                Create your Notaify account
              </h2>
              <p className="mt-2 text-sm text-gray-400">
                Start monitoring errors in minutes
              </p>
            </div>
